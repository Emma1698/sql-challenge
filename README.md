...
### Before I Begin
1. I created a new repository for this project called sql-challenge.
2. I clone the new repository to my computer.
3. Inside my local Git repository, I created a directory for this Challenge. I used a folder name that corresponds to the Challenge, such as EmployeeSQL.
